<x-app-layout>
    <div class="relative">
        <!-- Background image -->
        <img src="{{asset('photos/passager.jpg')}}" class="absolute top-0 left-0 w-screen h-screen object-cover z-0" alt="Background">

        <!-- Content -->
        <div class="flex flex-col items-center justify-center p-12 relative z-10">
            <!-- Form -->
                            ...
                            <div class="flex-auto ml-3 justify-evenly py-2">
                                ...
                                <div class="flex py-4 text-sm text-gray-500">
                                    <div class="flex-1 inline-flex items-center space-betwen">
                                        ...
                                        <p class="">{{ $reservation->depart }}</p>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        </svg>
                                        <p class="">{{ $reservation->destination }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex space-x-3 text-sm font-medium">
                                    ...
                                    <button class="mb-2 md:mb-0 bg-gray-900 px-5 py-2 shadow-sm tracking-wider text-white rounded-full hover:bg-gray-800" type="button" aria-label="like">Réserver</button>
                                </div>
                            </div>
                        </div>
                    </div>
